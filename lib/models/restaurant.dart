import 'package:full_food/models/cart_item.dart';
...
class Restaurant extends ChangeNotifier {
  ...
  final List<Food> _menu = [
    ...
    Food(
      ...
      description:
          'A juicy patty with melted cheddar, lettuce, tomato, and a hint of onion and pickle.',
      imagePath: 'lib/images/burger/bur2.jpg',
      price: 8.99,
      category: Foodcategory.burgers,
      availableAddons: [
        Addon(name: 'Extra Cheese', price: 0.99),
    ...
    Food(
      ...
      description:
          'A juicy patty with melted cheddar, lettuce, tomato, and a hint of onion and pickle.',
      imagePath: 'lib/images/burger/bur3.jpg',
      price: 8.99,
      category: Foodcategory.burgers,
      availableAddons: [
        Addon(name: 'Extra Cheese', price: 0.99),
    ...
    Food(
      ...
      description:
          'A juicy patty with melted cheddar, lettuce, tomato, and a hint of onion and pickle.',
      imagePath: 'lib/images/burger/bur5.jpg',
      price: 8.99,
      category: Foodcategory.burgers,
      availableAddons: [
        Addon(name: 'Extra Cheese', price: 0.99),
    ...
    Food(
      ...
      description:
          'A juicy patty with melted cheddar, lettuce, tomato, and a hint of onion and pickle.',
      imagePath: 'lib/images/salad/sal1.jpg',
      price: 8.99,
    ...
    Food(
      ...
      description:
          'A juicy patty with melted cheddar, lettuce, tomato, and a hint of onion and pickle.',
      imagePath: 'lib/images/salad/sal2.jpg',
      price: 8.99,
      category: Foodcategory.salads,
      availableAddons: [
        Addon(name: 'Extra Cheese', price: 0.99),
    ...
    Food(
      ...
      description:
          'A juicy patty with melted cheddar, lettuce, tomato, and a hint of onion and pickle.',
      imagePath: 'lib/images/salad/sal4.jpg',
      price: 8.99,
      category: Foodcategory.salads,
      availableAddons: [
        Addon(name: 'Extra Cheese', price: 0.99),
    ...
    Food(
      ...
      description:
          'A juicy patty with melted cheddar, lettuce, tomato, and a hint of onion and pickle.',
      imagePath: 'lib/images/salad/sal5.jpg',
      price: 8.99,
      category: Foodcategory.salads,
      availableAddons: [
        Addon(name: 'Extra Cheese', price: 0.99),
    ...
    Food(
      ...
      description:
          'A juicy patty with melted cheddar, lettuce, tomato, and a hint of onion and pickle.',
      imagePath: 'lib/images/dessert/des2.jpg',
      price: 8.99,
      category: Foodcategory.desserts,
      availableAddons: [
        Addon(name: 'Extra Cheese', price: 0.99),
    ...
    Food(
      ...
      description:
          'A juicy patty with melted cheddar, lettuce, tomato, and a hint of onion and pickle.',
      imagePath: 'lib/images/dessert/des4.jpg',
      price: 8.99,
      category: Foodcategory.desserts,
      availableAddons: [
        Addon(name: 'Extra Cheese', price: 0.99),
    ...
    Food(
      ...
      description:
          'A juicy patty with melted cheddar, lettuce, tomato, and a hint of onion and pickle.',
      imagePath: 'lib/images/dessert/des5.jpg',
      price: 8.99,
      category: Foodcategory.desserts,
      availableAddons: [
        Addon(name: 'Extra Cheese', price: 0.99),
    ...
    Food(
      ...
      description:
          'A juicy patty with melted cheddar, lettuce, tomato, and a hint of onion and pickle.',
      imagePath: 'lib/images/drink/drink1.jpg',
      price: 8.99,
    ...
    Food(
      ...
      description:
          'A juicy patty with melted cheddar, lettuce, tomato, and a hint of onion and pickle.',
      imagePath: 'lib/images/drink/drink2.jpg',
      price: 8.99,
      category: Foodcategory.drinks,
      availableAddons: [
        Addon(name: 'Extra Cheese', price: 0.99),
    ...
    Food(
      ...
      description:
          'A juicy patty with melted cheddar, lettuce, tomato, and a hint of onion and pickle.',
      imagePath: 'lib/images/drink/drink3.jpg',
      price: 8.99,
      category: Foodcategory.drinks,
      availableAddons: [
        Addon(name: 'Extra Cheese', price: 0.99),
